    ...
    methods: {
        ...
        async init() {
            ...
            try {
                ...
                const initialTask = tasks[this.task];
                const initialPolicy = policies[this.policy];
                await this.runtime.init({
                    scenePath: initialTask[0],
                    metaPath: initialTask[1],
                    policyPath: initialPolicy,
                });
                this.runtime.resume();
        ...
        async updateTaskCallback() {
            ...
            await this.runtime.loadEnvironment({
                scenePath: mjcf_path,
                metaPath: meta_path,
                policyPath: policies[this.policy],
            });
            this.runtime.resume();
            this.applyCommandState();
        },
